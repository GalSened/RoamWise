/**
 * In-Memory Mock Database for Vercel Serverless
 *
 * Note: This is a mock database. In serverless, each invocation
 * may have fresh state. For production, use a proper database service.
 */
