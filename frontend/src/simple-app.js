  ...
  if (generateBtn) {
    generateBtn.addEventListener('click', async () => {
      ...
      try {
        ...
        const selectedDuration = document.querySelector('.ios-segment.selected')?.textContent || 'Full day';
        const selectedInterests = Array.from(document.querySelectorAll('.ios-interest.selected')).map(el => el.textContent);
